...
Now that we've got data, we're ready to train a model using an algorithm. We'll start with the default `linear` algorithm to demonstrate the basics. See the [Algorithms](https://github.com/postgresml/postgresml/blob/master/docs/guides/training/algorithm\_selection) for a complete list of available algorithms.
...
If you've already been through the [Training Overview](https://github.com/postgresml/postgresml/blob/master/docs/guides/training/overview), you can see the results of those efforts:
...
Take a look at [Deploying Models](https://github.com/postgresml/postgresml/blob/master/docs/guides/predictions/deployments) documentation for more details.
